                ...
                return GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (ctx) =>
                        ChartsPage(countryCode: topCharts[index].country.toString(),
  ...
  Widget designChartImage({required String country,required int index}){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("Top 20",style: GoogleFonts.montserrat(
            color: textLight,
            fontSize: 16,
          ),),
        ...
        SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context,index){
                return GestureDetector(
                  onTap: (){
                    Helpers().getArtistData(topArtists[index].name).then((value) => {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
